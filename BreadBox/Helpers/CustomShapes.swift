...
//    }
    ...
    static var lump: UIBezierPath {
        let path = UIBezierPath()
        path.move(to: CGPoint(x: 158, y: 99))
        path.addLine(to: CGPoint(x: 0, y: 99))
        path.addCurve(to: CGPoint(x: 68.6, y: 0), controlPoint1: CGPoint(x: 1.8, y: 66), controlPoint2: CGPoint(x: 18.1, y: 0))
        path.addCurve(to: CGPoint(x: 158, y: 99), controlPoint1: CGPoint(x: 119.1, y: 0), controlPoint2: CGPoint(x: 149.2, y: 66))
        path.close()
        return path
    }
}
