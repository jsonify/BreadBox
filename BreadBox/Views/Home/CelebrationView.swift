...
struct CelebrationView: View {
    ...
    var body: some View {
        ...
        let angularGradient = AngularGradient(gradient: gradient, center: .center, angle: .zero)
        
        return VStack {
            Text("\(compliment.randomElement() ?? "You. Are. Awesome")")
                .padding()
                ...
                .frame(width: screen.width - 30, height: screen.height - 200)
